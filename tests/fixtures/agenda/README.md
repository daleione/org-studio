# Org Agenda M0 behavior baseline

Baseline upstream: Org Mode `main` commit `437fd11` (2026-08-04).

The fixture records the M0/P0 subset used by the native semantic layer:
...
functions are preserve-only and deliberately outside the native P0 parser.
