...
#let font-bold = (
  sys.inputs.at("theme-font-heading", default: "Optima"),
  "PingFang SC",
)
#let font-mono = (
...
// Keep the document title centred and unadorned; a short rule with no label
// reads like an incomplete heading in the export preview.
#let poster-title(title) = block(width: 100%, above: px(30), below: px(32))[
  #align(center)[
    #set text(
      font: hf(1, font-bold),
      size: tx(size-h1 + 4),
