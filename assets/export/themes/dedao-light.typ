...
#let theme-ink = rgb(sys.inputs.at("theme-color-ink", default: "#111418"))
#let theme-muted = rgb(sys.inputs.at("theme-color-muted", default: "#677084"))
...
#let theme-border = rgb(sys.inputs.at("theme-color-border", default: "#ced4da"))
...
#let margin-x   = 39pt
#let margin-top = 78pt
#let margin-bot = 39pt   // 540 × (24/331)
#let long-page-min-height = 720pt

#let color-bg          = theme-bg
#let color-title       = rgb("#404040")  // workDetail.vue .poster__title
#let color-text        = theme-ink
#let color-meta-strong = theme-ink
#let color-meta-light  = theme-muted
#let color-link        = theme-primary
#let color-quote-bg    = rgb("#f5f7fa")
#let color-code-bg     = theme-panel
#let color-table-bd    = theme-border
#let color-table-head  = rgb("#f7f7f7")
#let color-divider     = rgb("#E5E6EA")
...
#let conf(doc) = {
  ...
  show heading.where(level: 4): it => block(above: 52pt, below: 29pt, width: 100%)[
    #set text(font: hf(4, font-serif), size: tx(size-h4), weight: 600, fill: color-text)
    #set par(leading: 0.4em)
    #it.body
  ]
  show heading.where(level: 5): it => block(above: 52pt, below: 29pt, width: 100%)[
    #set text(font: hf(5, font-serif), size: tx(size-h5), weight: 600, fill: color-text)
    #set par(leading: 0.4em)
    #it.body
  ]
  show heading.where(level: 6): it => block(above: 52pt, below: 29pt, width: 100%)[
    #set text(font: hf(6, font-serif), size: tx(size-h6), weight: 600, fill: color-text)
    #set par(leading: 0.4em)
    #it.body
  ]
  ...
  show table: it => block(width: 100%, stroke: 0.5pt + color-table-bd, radius: 13pt, breakable: true, it)
