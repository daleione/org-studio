...
pub(crate) const UNDO_DOCUMENT_COMMAND: &str = "org-studio.document.undo";
pub(crate) const REDO_DOCUMENT_COMMAND: &str = "org-studio.document.redo";
...
pub(crate) const SHOW_EDITOR_COMMAND: &str = "org-studio.workspace.show-editor";
pub(crate) const SHOW_READING_COMMAND: &str = "org-studio.workspace.show-reading";
pub(crate) const SHOW_SPLIT_COMMAND: &str = "org-studio.workspace.show-split";
...
const TANGLE_DOCUMENT_COMMAND: &str = "org-studio.babel.tangle-document";
const OPEN_LINK_AT_COMMAND: &str = "org-studio.navigation.open-link-at";
